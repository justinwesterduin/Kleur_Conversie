<?php
# HTML color picker already results in hex

use App\ColorConverterController;

require '../vendor/autoload.php';

$controller = new ColorConverterController();
$controller->inputCheck();
$hex = $controller->rgbToHex();
?>
                    ...
                    <span>
                        ...
                        <div>
                            <input name="rgb" id="rgb"
                                   class="w-16 rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" readonly value="RGB"
